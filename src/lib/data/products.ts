...
function enrichDescription(p: Product): string {
  ...
  out.push(
    "Professionele kwaliteit, scherp geprijsd met je gratis KLUSRPAS en advies van ex-schilders. Voor 09:00 besteld vanavond in huis, bezorgd door heel Nederland en België.",
  );
  return out.join(" ");
}
